...
from utils.shorten import shorten
import utils.ahk_forum as Preview
...
class AutoHotkey:
	...
	async def version(self, ctx):
		...
		down = "https://github.com/Lexikos/AutoHotkey_L/releases/download/{}/AutoHotkey_{}_setup.exe".format(version,
																											 version[
																											 1:])
